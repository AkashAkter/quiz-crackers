...
2. In paths I've set some API which will show the details. In home I've just shown topic list and in that I've added a button which will take me to the quiz on that topic.
